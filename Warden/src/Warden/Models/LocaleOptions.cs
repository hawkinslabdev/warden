...
/// <summary>Locale settings for localization: date formatting and the locale table.</summary>
public sealed class LocaleOptions
{
    /// <summary>BCP 47 culture name (e.g., "nl-NL"). Defaults to invariant format if null.</summary>
    public string? Culture { get; set; }

    /// <summary>Selects the locale file <c>content/locale/{code}.json</c> (e.g. "nl").
