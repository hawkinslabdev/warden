...
| `degradedBelowPercent` | A day's tick turns down (not just degraded) when that day's uptime% falls below this. Unset keeps the stricter default: down only when every check that day failed. |
