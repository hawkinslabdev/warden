...
| `monitors` | The monitor ids this incident or window applies to, e.g. `monitors: [forgejo]`. A single id also works. `all` means every configured monitor, for a system-wide incident or maintenance window. |
